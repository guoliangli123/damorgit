(function(win) {
    function damoHtmlDiff() {
        this.MODE_CHARACTER = 1;
        this.MODE_TAG = 2;
        this.MODE_WHITESPACE = 3;
        this.ACTION_EQUAL = 1;
        this.ACTION_DELETE = 2;
        this.ACTION_INSERT = 3;
        this.ACTION_NONE = 4;
        this.ACTION_REPLACE = 5;
        this.specialCaseOpeningTags = new Array('<strong[\\>\\s]+', '<b[\\>\\s]+', '<i[\\>\\s]+', '<big[\\>\\s]+', '<small[\\>\\s]+', '<u[\\>\\s]+', '<sub[\\>\\s]+', '<sup[\\>\\s]+', '<strike[\\>\\s]+', '<s[\\>\\s]+');
        this.specialCaseClosingTags = new Array('</strong>', '</b>', '</i>', '</big>', '</small>', '</u>', '</sub>', '</sup>', '</strike>', '</s>');
        this.content = '';
        this.wordIndices = '';
        this.oldWords = '';
        this.newWords = '';
    }
    damoHtmlDiff.prototype = {
    ...
    win.damoHtmlDiff = new damoHtmlDiff();
})(window);
